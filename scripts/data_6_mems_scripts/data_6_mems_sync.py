# google drive --> vm
# note that this script only syncs root-level CSV files in the Data_6_MEMS folder, not subfolder
# not to be used locally, only on the vm
